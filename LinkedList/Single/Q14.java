...
public static void main(String[] args) {
    ...
    sll.insertInSortedList(5);  // Inserting 5 into the sorted list
    sll.insertInSortedList(12); // Inserting 12 into the sorted list
    sll.insertInSortedList(0);  // Inserting 0 into the sorted list

    System.out.println("After Inserting Elements:");
    sll.display(); // Print updated list
}
}
