//Merge two sorted linked list's
...
public class SingleLinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Original Sorted Lists:");
        sll.display(); // Print original sorted list 1
        System.out.println();

        sll2.display(); // Print original sorted list 2
        System.out.println();
